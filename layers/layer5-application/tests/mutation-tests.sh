...
manifest={"schema":"ashipaos.jellyfin-mpv-shim.slot.v1","name":"jellyfin-mpv-shim","version":"3.0.0","executable":"bin/jellyfin-mpv-shim","sha256":hashlib.sha256(exe.read_bytes()).hexdigest(),"python_tag":"cp313","abi_tag":"cp313","platform_tag":"manylinux_2_27_aarch64","dependency_status":"RESOLVED"}
