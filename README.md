...
Appliance image for the Amlogic S905X3 A95X F3 Air that runs Jellyfin MPV Shim.
...
| Layer 1 rootfs | `layers/layer1-rootfs/scripts/build-rootfs.sh` | Debian bookworm arm64 rootfs with kernel, initramfs, mainline DTB, Python 3.11, libmpv |
...
| Layer 5 install | `layers/layer5-application/scripts/build-application.sh` | Jellyfin MPV Shim bundle and launcher in the rootfs |
